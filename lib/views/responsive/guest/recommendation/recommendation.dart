...
import 'package:compassinvest/views/responsive/guest/recommendation/recommendation_content.dart';
...
class GuestRecommendation extends StatefulWidget {
  ...
  @override
  _GuestRecommendationState createState() => _GuestRecommendationState();
}

class _GuestRecommendationState extends State<GuestRecommendation> {
  @override
